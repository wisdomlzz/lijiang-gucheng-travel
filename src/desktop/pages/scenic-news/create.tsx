...
export default function ScenicNewsCreate() {
  const navigate = useNavigate();
  const addNews = useContentManageStore((s) => s.addNews);
  const [form, setForm] = useState({
    title: "", imageUrl: "", tag: "", tagColor: "#3B82F6", date: "", summary: "", category: "其它" as NewsCategory, heroTitle: "", body: "",
  });
  ...
  return (
    <FormPage title="新建景区资讯" backPath="/desktop/scenic-news" onSave={handleSave} saving={saving}>
