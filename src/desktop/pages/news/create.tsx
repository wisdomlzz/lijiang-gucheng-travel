...
export default function NewsCreate() {
  ...
  const [form, setForm] = useState({
    title: "", tag: "", tagColor: "#3B82F6", date: "", summary: "", category: "", imageUrl: "", body: "",
  });
  ...
  const handleSave = () => {
    ...
    const item: NewsItem = {
      ...
      category: (form.category as any) || "其他",
  ...
  return (
    <FormPage title="新建资讯" backPath="/desktop/news" onSave={handleSave} saving={saving}>
