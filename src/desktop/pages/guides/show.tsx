...
export default function GuideShow() {
    ...
    return (
      <div className="p-6">
        <div className="flex items-center gap-2 mb-6">
          <button onClick={() => navigate("/desktop/guides")} className="w-8 h-8 flex items-center justify-center -ml-1">
  ...
  return (
    <PageLayout
      ...
      actions={
        <Button size="sm" variant="outline" onClick={() => navigate(`/desktop/guides/${guide.id}/edit`)}>
