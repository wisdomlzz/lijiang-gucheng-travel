...
const pins: Pin[] = [
  {
    ...
    left: "40%",
    image:
      "https://images.unsplash.com/photo-1545569341-9eb8b30979d9?auto=format&fit=crop&w=600&q=70",
    address: "丽江市古城区",
  ...
  { id: 2, name: "四方街", category: "view", top: "36%", left: "52%", image: "https://images.unsplash.com/photo-1524661135-423995f22d0b?auto=format&fit=crop&w=600&q=70", address: "古城中心", desc: "四方街是丽江古城的核心广场，自古以来为商贸集市之地。" },
  { id: 3, name: "木府", category: "view", top: "60%", left: "30%", image: "https://images.unsplash.com/photo-1599940824399-b87987ceb72a?auto=format&fit=crop&w=600&q=70", address: "古城区光义街", desc: "木府为明代丽江木氏土司衙署建筑群，气势恢宏。" },
  { id: 4, name: "大水车", category: "view", top: "14%", left: "62%", image: "https://images.unsplash.com/photo-1548013146-72479768bada?auto=format&fit=crop&w=600&q=70", address: "古城北入口", desc: "大水车是丽江古城的标志性景观，位于古城北入口。" },
  { id: 5, name: "万古楼", category: "view", top: "72%", left: "66%", image: "https://images.unsplash.com/photo-1528127269322-539801943592?auto=format&fit=crop&w=600&q=70", address: "狮子山", desc: "万古楼雄踞狮子山顶，可俯瞰整个古城。" },
  { id: 6, name: "纳西人家", category: "food", top: "44%", left: "38%", image: "https://images.unsplash.com/photo-1559339352-11d035aa65de?auto=format&fit=crop&w=600&q=70", address: "新华街", desc: "地道纳西族家宴菜。" },
  { id: 7, name: "阿妈意腊排骨", category: "food", top: "28%", left: "56%", image: "https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&w=600&q=70", address: "七一街", desc: "丽江特色腊排骨火锅。" },
  { id: 8, name: "花间堂", category: "hotel", top: "50%", left: "60%", image: "https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?auto=format&fit=crop&w=600&q=70", address: "五一街", desc: "精品纳西风情客栈。" },
  { id: 9, name: "雪山清吧", category: "bar", top: "54%", left: "56%", image: "https://images.unsplash.com/photo-1514933651103-005eec06c04b?auto=format&fit=crop&w=600&q=70", address: "酒吧街", desc: "古城必打卡音乐酒吧。" },
  { id: 10, name: "木府院落", category: "courtyard", top: "58%", left: "32%", image: "https://images.unsplash.com/photo-1683825093397-5bbc64e496e6?auto=format&fit=crop&w=600&q=70", address: "光义街官门口", desc: "文化院落打卡点，支持到这去导航。" },
  { id: 11, name: "游客咨询服务点", category: "service", top: "30%", left: "44%", image: "https://images.unsplash.com/photo-1524661135-423995f22d0b?auto=format&fit=crop&w=600&q=70", address: "玉河广场", desc: "提供游客咨询、便民服务指引。" },
  { id: 12, name: "北门洗手台", category: "handwash", top: "18%", left: "58%", image: "https://images.unsplash.com/photo-1589556264800-08ae9e129a29?auto=format&fit=crop&w=600&q=70", address: "大水车入口旁", desc: "导览地图洗手台点位信息。" },
  { id: 13, name: "四方街公厕", category: "toilet", top: "38%", left: "50%", image: "https://images.unsplash.com/photo-1583241801098-89ef566af2a4?auto=format&fit=crop&w=600&q=70", address: "四方街南侧", desc: "支持第三卫生间、无障碍等标签展示。" },
  { id: 14, name: "北门应急避难点", category: "shelter", top: "20%", left: "34%", image: "https://images.unsplash.com/photo-1573804633927-bfcbcd909acd?auto=format&fit=crop&w=600&q=70", address: "北门广场", desc: "应急避难点位置与说明。" },
  { id: 15, name: "北门入口", category: "entrance", top: "12%", left: "50%", image: "https://images.unsplash.com/photo-1528728329032-2972f65dfb3f?auto=format&fit=crop&w=600&q=70", address: "古城北入口", desc: "古城出入口导览信息。" },
];
...
export function MapPage() {
  ...
  const getParkingColor = (type: "self_operated" | "third_party") =>
    type === "self_operated" ? "#3B82F6" : "#F97316";

  const getParkingIcon = (type: "self_operated" | "third_party") =>
    type === "self_operated" ? Building2 : Store;
          ...
          {activeCat === "parking" ? (
            ...
            visiblePins.map((p) => (
              ...
              >
                ...
                <div
                  className="mt-0.5 text-[10px] text-center whitespace-nowrap px-1 rounded bg-white/90 text-text-body shadow-sm"
                >
                  {p.name}
                </div>
              </button>
          ...
          <div className="px-4 py-3 max-h-[50vh] overflow-y-auto">
            {detailTab === "intro" && (
              <div>
                ...
                <div className="text-[12px] text-primary font-medium mb-3">
                  共 {selectedPin.totalSpots ?? 0} 个车位
                </div>
            ...
            {detailTab === "share" && (
              <div className="py-6 text-center">
                ...
                <div className="text-[13px] text-text-body">
                  分享「{selectedPin.name}」给好友
                </div>
                <div className="flex justify-center gap-3 mt-4">
                  <button className="h-9 px-5 rounded-full bg-[#F5EFE2] text-[12px] text-text-body">
                    微信好友
                  </button>
                  <button className="h-9 px-5 rounded-full bg-[#F5EFE2] text-[12px] text-text-body">
                    朋友圈
