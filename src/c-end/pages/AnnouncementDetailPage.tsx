    ...
    <div className="min-h-screen bg-surface-page">
      ...
      <div className="px-4 py-4">
        ...
        <div className="flex items-center gap-2 mb-3">
          <span className="text-[12px] text-white px-2 py-0.5 rounded-full bg-red-500">
            公告
          </span>
          <span className="text-[12px] text-text-tertiary">
            发布于 {formatDateTime(announcement.publishTime)}
          </span>
        </div>
        ...
        {/* 内容 */}
        <div className="text-[15px] text-text-body leading-relaxed whitespace-pre-wrap">
