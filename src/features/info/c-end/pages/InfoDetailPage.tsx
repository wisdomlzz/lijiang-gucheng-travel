  ...
  return (
    <div className="min-h-screen bg-surface-page pb-8">
      ...
      <div className="relative">
        <ImageWithFallback src={item.imageUrl} alt={item.title} className="w-full h-[220px] object-cover" />
      ...
      <div className="px-3 mt-4">
        <div className="bg-white rounded-2xl p-4 shadow-[0_4px_14px_rgba(60,120,200,0.10)]">
          ...
          <div className="rounded-xl overflow-hidden">
            <ImageWithFallback src={item.subImage} alt={item.title} className="w-full h-[180px] object-cover" />
          </div>
