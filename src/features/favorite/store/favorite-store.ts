...
export const useFavoriteStore = create<FavoriteState>((set, get) => ({
  favorites: [
    ...
    },
    {
      ...
      itemId: 1,
      name: "古城经典一日游",
      img: "https://images.unsplash.com/photo-1528127269322-7c8d1f6e4c1f?w=400",
      savedAt: "2026-05-07",
    },
    {
      id: "fav3",
      ...
      type: "article",
      itemId: 3,
      name: "东巴纸：从树皮到文字的千年工艺",
      img: "https://images.unsplash.com/photo-1606166325683-e6deb697d301?w=400",
      savedAt: "2026-05-06",
    },
  ],
