...
const DEFAULT: Courtyard[] = [
  {
    ...
    description: "木府是丽江古城之心脏，原为明代木氏土司府邸，建筑群气势恢宏，被誉为「丽江紫禁城」。",
    location: "古城光义街官门口",
    hours: "08:30-17:30",
  ...
  },
  {
    ...
    description: "著名纳西族历史学家方国瑜先生的故居，保留了大量珍贵手稿与历史文献。",
    location: "五一街文治巷42号",
    hours: "09:00-17:00",
  ...
  },
  {
    ...
    summary: "每晚上演原生态纳西古乐表演。",
    description: "每晚在古城内上演的原生态纳西古乐表演，被誉为「音乐活化石」。",
    location: "古城新义街纳西古乐会",
    hours: "20:00-21:30",
  ...
  },
  {
    ...
    summary: "清代丽江最早官办学堂。",
    description: "清代丽江最早的官办学堂，至今仍保留藏书、讲学功能。",
    location: "五一街文治巷15号",
    hours: "09:00-18:00",
    ...
    gallery: ["https://images.unsplash.com/photo-1663609968423-657ff4f0dd5a?auto=format&fit=crop&w=800&q=70"],
    lat: 26.8695,
    lng: 100.2368,
  },
]
...
export const useContentCourtyardStore = create<State>((set) => ({
  courtyards: DEFAULT,
  addCourtyard: (item) => set((s) => ({ courtyards: [...s.courtyards, item] })),
