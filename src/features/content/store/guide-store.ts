...
const DEFAULT: TravelGuide[] = [
  {
    ...
    description:
      "带你一次走完古城最具代表性的六处热门地标，从大水车到万古楼，串起古城的历史脉络与烟火气息，适合初次来丽江的游客。",
    ...
    contentBlocks: [
      {
        id: "cb1",
        type: "text",
        text: "丽江古城位于云南省丽江市古城区，是中国历史文化名城中保存最为完整的古城之一。古城始建于宋末元初，距今已有800多年的历史。\n\n漫步在古城的青石板路上，两侧是古朴的纳西族民居，潺潺的水渠穿城而过，构成了一幅「小桥流水人家」的诗意画卷。",
      },
    ],
    spots: [
  ...
  },
  {
    ...
    description:
      "走进明清木氏土司府邸，由资深讲解员带领，系统了解纳西文化与木府六百年兴衰，适合亲子研学与深度文化爱好者。",
...
export const useContentGuideStore = create<State>((set) => ({
  guides: DEFAULT,
  addGuide: (item) => set((s) => ({ guides: [...s.guides, item] })),
