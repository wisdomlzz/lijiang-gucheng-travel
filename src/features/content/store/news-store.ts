...
const DEFAULT: NewsItem[] = [
  ...
  { id: "10", imageUrl: "https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?auto=format&fit=crop&w=800&q=70", title: "古城游览安全提醒", tag: "公告", tagColor: "#2563EB", date: "04-10", summary: "游览古城请注意人身财产安全", category: "其它", heroLine: ["游览古城请注意人身财产安全"], subImage: "https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?auto=format&fit=crop&w=800&q=70" },
]
