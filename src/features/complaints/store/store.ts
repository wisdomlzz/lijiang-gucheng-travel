...
const SEED: ComplaintType[] = [
  {
    ...
    userId: "u_c_001",
    type: "服务态度",
    content: "便民服务人员沟通态度不好，希望平台提醒整改",
    images: ["https://images.unsplash.com/photo-1562621019-4d2f3980df96?w=400"],
    status: "C10",
    ...
    reporterName: "张小游",
    reporterGender: "女",
    reporterPhone: "13800001001",
    objectType: "个人",
    incidentArea: "大研街道",
    incidentLocation: "五一街片区",
    doorplate: "五一街42号",
    channelNote: "小程序自有投诉渠道",
  },
  {
    id: "CP002",
    orderId: "CO20260511007",
    userId: "u_c_s_001",
    type: "价格争议",
    content: "现场报价和参考价格差距较大，希望平台复核",
    images: ["https://images.unsplash.com/photo-1562572159-4efc207a5a1e?w=400"],
    status: "C40",
    ...
    reporterName: "和女士",
    reporterGender: "女",
    reporterPhone: "13988880002",
    objectType: "个人",
    incidentArea: "七一社区",
    incidentLocation: "七一街片区",
    doorplate: "七一街88号",
    channelNote: "小程序自有投诉渠道",
  ...
  {
    id: "CP003",
    orderId: "CO20260511006",
    userId: "u_c_s_001",
    type: "服务结果",
    content: "建筑垃圾清运后现场仍有残留，需要重新处理",
    ...
    reporterName: "片区巡查员",
    reporterGender: "男",
    reporterPhone: "18800003001",
    objectType: "公共环境",
    incidentArea: "新华社区",
    incidentLocation: "新华街片区",
    doorplate: "新华街16号",
    channelNote: "小程序自有投诉渠道",
  ...
  {
    id: "CP004",
    orderId: "CO20260509000",
    userId: "u_c_001",
    type: "服务时效",
    content: "行李搬运服务迟到半小时，影响入住安排",
