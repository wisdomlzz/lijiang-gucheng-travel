  ...
  return (
    <PageLayout title="派单配置" description="配置便民服务自动派单策略">
      <div className="grid grid-cols-2 gap-4 mb-6">
        <Card>
          <CardHeader>
            <CardTitle className="text-sm">自动派单开关</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  toast.success(autoDispatch ? "自动派单已关闭" : "自动派单已开启")
                }}
              >
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-sm">派单策略说明</CardTitle>
          </CardHeader>
          <CardContent>
            <ul className="text-sm text-muted-foreground space-y-2">
              <li className="flex items-center gap-2">
                <span className="size-1.5 rounded-full bg-primary" />
                点对点服务：按距离分组，同组内选任务最少人员
              </li>
              <li className="flex items-center gap-2">
                <span className="size-1.5 rounded-full bg-primary" />
                片区服务：按片区匹配，选该片区任务最少人员
              </li>
              <li className="flex items-center gap-2">
                <span className="size-1.5 rounded-full bg-primary" />
                最多尝试 3 名服务人员，全部拒绝后转人工处理
              </li>
            </ul>
          </CardContent>
        </Card>
