...
const MOCK_B_NOTIFICATIONS: BNotification[] = [
  { id: "1", type: "order", title: "新订单提醒", summary: "您有1笔待处理订单，请尽快确认", time: "5分钟前", isRead: false },
  { id: "2", type: "order", title: "价格确认提醒", summary: "用户已收到报价，请留意后续支付状态", time: "15分钟前", isRead: false },
  { id: "3", type: "system", title: "系统升级公告", summary: "系统将于今晚22:00-23:00进行维护升级", time: "今天 14:30", isRead: true },
  { id: "4", type: "order", title: "服务完成确认", summary: "订单 CO20260509000 已由用户确认完成", time: "今天 09:42", isRead: true },
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          {unreadCount > 0 && (
            <button
              ...
              className="text-[13px] text-primary active:opacity-60"
            >
              全部已读
            </button>
          )}
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2 mb-0.5">
                      <h3
                        className={`text-[14px] ${
                          !item.isRead ? "font-medium text-text-body" : "text-text-secondary"
                        }`}
                      >
                        {item.title}
                      </h3>
                    ...
                    <p className="text-[12px] text-text-tertiary line-clamp-1">
                      {item.summary}
                    </p>
                  </div>
                </div>
