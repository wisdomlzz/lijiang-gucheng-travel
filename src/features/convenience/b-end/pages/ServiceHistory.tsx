...
export function ServiceHistory() {
  ...
  const monthOrders = convOrders.filter(
    o => o.staffId === currentStaffId && o.createdAt.startsWith(monthStr)
  );
  ...
  const onlineRevenue = monthOrders.filter(o => o.payMethod === "online").reduce((sum, o) => sum + (o.priceQuote ?? 0), 0);
    ...
    <div className="pb-4">
      ...
      >
        ...
        <div className="bg-white/90 backdrop-blur-xl rounded-2xl p-4 shadow-[0 4px 16px_rgba(60,120,200,0.10)]">
          ...
          <div className="mt-1 text-text-heading text-[28px] font-medium">
          ...
          >
            ...
            <div className="mt-2 flex items-center justify-between border-t border-[#F0F0F0] pt-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[14px] text-text-heading font-medium">
                  {h.amount ?? "—"}
                </span>
