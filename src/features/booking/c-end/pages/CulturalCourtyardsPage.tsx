    ...
    <div className="min-h-full bg-surface-page">
      ...
      <div className="px-3 py-3 space-y-3">
        <div className="rounded-2xl bg-white shadow-sm border border-slate-100 p-4">
          ...
          <div className="mt-2 flex items-center justify-between gap-3">
            <p className="text-[12px] text-text-tertiary">
              已打卡 {visitedIds.size}/{courtyards.length} 处院落
            </p>
        ...
        {visible.map((c) => {
          ...
          return (
            <div key={c.id} className="bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-100">
              <div className="flex p-3 gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <button onClick={() => navigate(`/c/courtyard/${c.id}`)} className="w-full text-left">
                    ...
                    <p className="mt-1.5 text-[12px] text-text-secondary line-clamp-2 leading-relaxed">
                      {c.description}
                    </p>
