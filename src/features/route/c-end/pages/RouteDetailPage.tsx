...
import routeIllustration from "@/c-end/assets/image-9.png"
  ...
  return (
    <div className="min-h-screen bg-surface-page pb-6">
        ...
        <div className="bg-white rounded-2xl overflow-hidden shadow-[0_4px_14px_rgba(60,120,200,0.10)]">
          ...
          {route.hasVideo && route.videoUrl && (
            <div className="px-3 py-3 border-t border-gray-100">
              ...
              <VideoPlayer src={route.videoUrl} poster={route.videoCoverUrl} className="aspect-video rounded-lg" />
            </div>
          )}
              ...
              <div key={slot.time} className="flex items-center gap-3">
                ...
                <div className="flex-1 h-5 bg-gray-100 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{ width: slot.width, backgroundColor: slot.color }}
                  />
                </div>
      ...
      <div className="px-3 mt-4">
        ...
        <div className="bg-white rounded-2xl overflow-hidden shadow-[0_4px_14px_rgba(60,120,200,0.10)]">
          <img src={routeIllustration} alt="路线示意" className="w-full h-auto object-cover block" />
        </div>
      </div>
            ...
            {route.contentBlocks.map((block) => (
              <div key={block.id}>
                ...
                {block.type === "image" && block.imageUrl && (
                  <div>
                    <img src={block.imageUrl} alt={block.imageCaption || "攻略图片"} className="w-full rounded-lg" />
                    {block.imageCaption && (
